    ...
    >
      ...
      >
        ...
        <div className="flex flex-1 min-h-0 overflow-hidden max-[640px]:flex-col">
          <nav className="w-40 shrink-0 border-r border-border py-3 px-2 flex flex-col gap-0.5 overflow-y-auto max-[640px]:w-full max-[640px]:flex-row max-[640px]:border-r-0 max-[640px]:border-b max-[640px]:border-border max-[640px]:overflow-x-auto max-[640px]:p-2 max-[640px]:gap-1">
            {sections.map((s) => (
              <button
                key={s.id}
