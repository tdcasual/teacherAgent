...
def test_teacher_routes_build_router():
    ...
    assert _has_route(router, "DELETE", "/teacher/memory/proposals/{proposal_id}")
    assert _has_route(router, "GET", "/teacher/student-memory/proposals")
    assert _has_route(router, "POST", "/teacher/student-memory/proposals")
    assert _has_route(router, "POST", "/teacher/student-memory/proposals/{proposal_id}/review")
    assert _has_route(router, "DELETE", "/teacher/student-memory/proposals/{proposal_id}")
    assert _has_route(router, "GET", "/teacher/student-memory/insights")
    ...
    assert not _has_route(router, "GET", "/teacher/personas")
