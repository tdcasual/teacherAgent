  ...
  return (
    ...
    >
      ...
      <PromptDialog
        ...
        label="会话名称"
        placeholder="输入会话名称"
        defaultValue={renameDialogSessionId ? sessionSidebar.getSessionTitle(renameDialogSessionId) : ''}
        confirmText="保存"
      ...
      <ConfirmDialog
        ...
        description={archiveDialogSessionId ? `会话：${sessionSidebar.getSessionTitle(archiveDialogSessionId)}` : undefined}
