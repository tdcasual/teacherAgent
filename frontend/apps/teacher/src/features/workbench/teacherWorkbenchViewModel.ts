...
type BuildTeacherWorkbenchViewModelParams<TWorkbench extends object, TRest extends object> = {
  workbench: TWorkbench;
} & TRest;

export function buildTeacherWorkbenchViewModel<TWorkbench extends object, TRest extends object>(
