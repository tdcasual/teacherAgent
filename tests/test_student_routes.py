...
def test_student_routes_build_router():
    ...
    assert not _has_route(router, "GET", "/student/personas")
    assert not _has_route(router, "POST", "/student/personas/custom")
    assert not _has_route(router, "PATCH", "/student/personas/custom/{persona_id}")
    assert not _has_route(router, "POST", "/student/personas/activate")
