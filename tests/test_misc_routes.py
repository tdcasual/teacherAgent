...
def test_misc_routes_build_router():
    ...
    assert _has_route(router, "GET", "/auth/admin/subjects")
    assert _has_route(router, "POST", "/auth/admin/subjects")
    assert _has_route(router, "POST", "/auth/admin/subjects/seed")
    assert _has_route(router, "GET", "/auth/admin/roster")
    assert _has_route(router, "POST", "/auth/admin/roster")
    assert _has_route(router, "DELETE", "/auth/admin/roster")
    assert _has_route(router, "GET", "/auth/admin/enrollments")
    assert _has_route(router, "POST", "/auth/admin/enrollments/enroll-class")
    assert _has_route(router, "POST", "/auth/admin/enrollments/enroll")
    assert _has_route(router, "POST", "/auth/admin/enrollments/unenroll")
    assert _has_route(router, "POST", "/auth/admin/enrollments/bulk-move")
    assert _has_route(router, "POST", "/auth/admin/enrollments/rename-class")
