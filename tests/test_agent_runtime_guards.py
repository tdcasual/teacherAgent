...
def test_maybe_guard_teacher_subject_total_is_noop():
    ...
    deps = AgentRuntimeDeps(
        ...
        extract_exam_id=lambda text: "EX20260209_9b92e1",
        is_exam_analysis_request=lambda text: True,
        build_exam_longform_context=lambda exam_id: {"exam_overview": {"ok": True, "score_mode": "total"}},
