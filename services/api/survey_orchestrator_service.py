...
def _transition_job(job_id: str, job: Dict[str, Any], target_status: str, deps: SurveyOrchestratorDeps, **updates: Any) -> Dict[str, Any]:
...
def _payload_has_unstructured_input(payload: Dict[str, Any]) -> bool:
    return any(
        ...
        for key in ("attachments", "html", "text", "report_text")
    )
