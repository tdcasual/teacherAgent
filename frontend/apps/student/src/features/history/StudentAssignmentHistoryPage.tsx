      ...
      <div className="mx-auto grid max-w-[720px] gap-4">
        ...
        {items.map((item) => (
          <article
            ...
            className="grid gap-2 rounded-[16px] border border-border bg-white px-4 py-3"
          >
